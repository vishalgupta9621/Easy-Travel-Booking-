...
export class HotelOwnerRegistrationController {
  async submitRegistration(req, res, next) {
    try {
      ...
      try {
        ...
        // Store registration data (you can add database storage here if needed)
        // For now, we're just sending emails
  ...
  // Get registration status (optional endpoint for future use)
...
export default new HotelOwnerRegistrationController();
